...
export const ffe0: Driver = {
  ...
  power(on, name) {
    ...
    return isStage(name)
      ...
      : f(0x7e, 0xff, 0x04, v, 0x00, 0xff, 0xff, 0x00, 0xef)
  },

  rgb: (r, g, b) =>
    f(0x7e, 0xff, 0x05, 0x03, byte(r), byte(g), byte(b), 0xff, 0xef),

  brightness: (v) => f(0x7e, 0xff, 0x01, pct(v), 0x00, 0xff, 0xff, 0xff, 0xef),

  speed: (v) => f(0x7e, 0xff, 0x02, pct(v), 0x00, 0xff, 0xff, 0xff, 0xef),
  ...
  effect: (e) => f(0x7e, 0x00, 0x0e, byte(e.id), 0xff, 0xff, 0xff, 0xff, 0xef),
}
